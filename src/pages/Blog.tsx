...
const Blog = () => {
  const blogPosts = [
    {
      ...
      excerpt: "Exploring the benefits of unified AI interfaces and how aggregation platforms are changing the landscape of artificial intelligence development.",
    ...
    },
    {
      ...
      excerpt: "Learn advanced techniques for crafting effective prompts that get better results from language models. Includes practical examples and best practices.",
      author: "Sarah Chen",
      authorRole: "CTO",
      date: "March 10, 2024",
      readTime: "8 min read",
    ...
    },
    {
      ...
      excerpt: "We put the leading AI models head-to-head across various tasks to help you choose the right tool for your specific use case.",
      author: "Emily Watson",
    ...
    },
    {
      ...
      excerpt: "A step-by-step tutorial on integrating t3Dotgg's API into your applications, with code examples and real-world use cases.",
  ...
  const categories = ["All", "Industry Insights", "Technical Guide", "Research", "Tutorial"];
