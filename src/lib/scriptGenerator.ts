...
export function generateEmbedHTML(embedCode: string): string {
  return `<script src="https://lux-llm-prod.vercel.app/embed/${embedCode}.js"></script>`;
}
...
export function generateIframeEmbed(
  ...
  return `<iframe src="https://lux-llm-prod.vercel.app/embed/${embedCode}" width="${width}" height="${height}" style="border: none; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.15);"></iframe>`;
}
...
useEffect(() => {
  ...
  script.src = 'https://lux-llm-prod.vercel.app/embed/${embedCode}.js';
  script.async = true;
...
{{ 'https://lux-llm-prod.vercel.app/embed/' | append: '${embedCode}' | append: '.js' | script_tag }}`,

    wix: `<!-- Add this to your Wix site's HTML element -->
<iframe src="https://lux-llm-prod.vercel.app/embed/${embedCode}" width="400" height="600" style="border: none; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.15);"></iframe>`,
